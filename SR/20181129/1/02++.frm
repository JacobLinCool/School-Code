...
Private Sub Timer1_Timer()
    ...
    If Image1.Top < Image2.Top And Image1.Top > (Image2.Top - Image2.Height) And Image1.Left > Image2.Left And Image1.Left < (Image2.Left + Image2.Width) Then
        MsgBox ("You hit the pig!")
        Timer1.Interval = 0
    End If
End Sub
